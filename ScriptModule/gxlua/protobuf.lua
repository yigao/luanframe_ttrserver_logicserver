...
--WHJ lua io.open bug
function protobuf.register_file_c(filename)
	local buffer = c._read_file(filename)
	c._env_register(P, buffer)
	local protoData = decode("google.protobuf.FileDescriptorSet", buffer)
	--local protoData = protobuf.decode("google.protobuf.FileDescriptorSet", buffer)
	--messageFactory:register(protoData.file[1], filename)
	return protoData.file[1]
	--return buffer
end
